...
var base_wallet = require('swtc-wallet').Wallet;
var convertBytesToAddress = require('swtc-keypairs').convertBytesToAddress;
var convertAddressToBytes = require('swtc-keypairs').convertAddressToBytes;
